          ...
          <Reveal>
            <div className="space-y-10 leading-relaxed text-ink-700">
              <Block title="1. Verantwortlicher">
                <p>
                  Verantwortlicher im Sinne der DSGVO und sonstiger datenschutzrechtlicher
                  Bestimmungen ist:
                </p>
                <p className="mt-2 font-medium text-ink-900">{provider.name}</p>
                <p>{provider.legalForm}</p>
                <Address lines={provider.address} />
                <p className="mt-2">Vertreten durch {controller.representedBy}.</p>
                <p className="mt-2">Telefon: {controller.phone}</p>
                <p>
                  E-Mail:{' '}
                  <a
              ...
              <Block title="2. Behördlicher Datenschutzbeauftragter">
                <p className="font-medium text-ink-900">{dpo.name}</p>
                {dpo.unit && <p>{dpo.unit}</p>}
                <Address lines={dpo.address} />
                {dpo.phone && <p className="mt-2">Telefon: {dpo.phone}</p>}
                <p className={dpo.phone ? '' : 'mt-2'}>
                  E-Mail:{' '}
                  <a
                    className="text-arc-700 hover:underline"
              ...
              <Block title="3. Bereitstellung der Website und Erstellung von Logfiles">
                <p>
                  ...
                  <strong>{hosting.provider}</strong>, {hosting.address}, gehostet. Beim
                  Aufruf der Website verarbeitet der Hosting-Anbieter automatisch
                  Informationen, die Ihr Browser übermittelt, in sogenannten
                  Server-Logfiles. Dies sind insbesondere:
                </p>
                ...
                <p className="mt-2">
                  ...
                  an einem technisch fehlerfreien und sicheren Betrieb der Website (Art. 6
                  Abs. 1 lit. f DSGVO).
                </p>
                <p className="mt-2">
                  Bei der Nutzung von {hosting.service} können Daten in die USA übertragen
                  werden. {hosting.provider} ist nach dem EU-U.S. Data Privacy Framework
                  zertifiziert. Weitere Informationen finden Sie in der{' '}
                  <a
                    className="text-arc-700 hover:underline"
